...
from pipeline.novel_pipeline_v3 import create_pipeline_v3
from core.memory import StoryMemory
from core.prompt_assembler import PromptAssembler


DEBUG_DIR = "debug_output_v3"
...
...""",
    ...
    # 3. 创建 Pipeline V3
    print("\n[Debug] 创建 Pipeline V3...")
    pipeline = create_pipeline_v3(
